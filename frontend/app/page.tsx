      ...
      {isAuthenticated && (
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-8">Your Content Hub</h2>
            <Tabs defaultValue="create" className="space-y-6">
              <TabsList className="grid w-full grid-cols-2">
                <TabsTrigger value="create">Create Fingerprint</TabsTrigger>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          <h2 className="text-3xl font-bold mb-4">
            {isAuthenticated ? 'Explore More Features' : 'Ready to Own Your Creations?'}
          </h2>
          <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">
            {isAuthenticated 
              ? 'Discover advanced features for content protection and monetization'
              : 'Join the protocol that puts creators first'
            }
          </p>
          <Link href={isAuthenticated ? "/trace" : "/dashboard"}>
